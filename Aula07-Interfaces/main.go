...
func main() {
	client, _ := entity.CreateClient("John Doe", true, "123.456.789-09", "johndoe@gmail.com", "(11) 99999-9999", time.Date(1990, time.January, 01, 0, 0, 0, 0, time.Local), entity.CLIENT)
	...
	fmt.Println("-------------------------------------------------------")
	_, error := entity.CreateClient("Emilly Doe", true, "123.456.789-00", "emillyDoe@gmail.com", "(22) 88888-8888", time.Date(1990, time.January, 01, 0, 0, 0, 0, time.Local), entity.CLIENT_PLUS)
	fmt.Println(error)
}
